...
const EXECUTORS = {
  ...
  move_to_known_location: (bot, args, ctx) => movement.moveToKnownLocation(bot, args, ctx),
...
const DESCRIPTIONS = {
  ...
  move_to_known_location: 'Travel to a trusted remembered location by name (e.g. crafting_station). Never takes coordinates.',
