...
const DESCRIPTIONS = {
  ...
  attack_entity: 'Attack an entity with bounded duration.',
  stop_attacking: 'Stop combat.',
  equip_item: 'Equip a named inventory item.',
  ...
  mine_block: 'Dig the block at exact coordinates.',
  mine_block_type: 'Find and dig up to count blocks of a type.',
